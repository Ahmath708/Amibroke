...
const styles = StyleSheet.create({
  ...
  referralCode: { fontFamily: Typography.fonts.heading, fontSize: Typography.title2.fontSize, fontWeight: '700', color: Colors.accent, letterSpacing: 2 },
  shareBtn: { width: '100%' },
  ...
  toneBtnActive: { backgroundColor: Colors.accentContainer },
  ...
  addText: { fontFamily: Typography.fonts.body, fontSize: Typography.callout.fontSize, color: Colors.accent },
  ...
  resultScore: { fontFamily: Typography.fonts.heading, fontSize: Typography.title3.fontSize, fontWeight: '700', color: Colors.accent },
