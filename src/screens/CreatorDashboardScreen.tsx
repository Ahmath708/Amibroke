...
const styles = StyleSheet.create({
  ...
  toneBtn: { paddingHorizontal: Spacing.sm, paddingVertical: Spacing.xs, borderRadius: Radius.pill, backgroundColor: Colors.groupedRow },
  ...
  batchInput: {
    ...
    color: Colors.textPrimary, backgroundColor: Colors.groupedRow, borderRadius: Radius.md,
